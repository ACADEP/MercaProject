                                            ...
                                            <div class="form-group">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="{{ route('brand.lowest', $products->first()->category) }}">Menor Precio</a>
                                                        <a class="dropdown-item" href="{{ route('brand.highest', $products->first()->category) }}">Mayor Precio</a>
                                                        <a class="dropdown-item" href="{{ route('brand.alpha.lowest', $products->first()->category) }}">Productos A-Z</a>
                                                        <a class="dropdown-item" href="{{ route('brand.alpha.highest', $products->first()->category) }}">Productos Z-A</a>                                            
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
