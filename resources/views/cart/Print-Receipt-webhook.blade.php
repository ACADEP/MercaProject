...
<html lang="es">
  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <div class="row mb-3" id="dates">
        <div class="col-sm-6 col-md-6" id="project">
          ...
          <div><span><strong>Dirección</strong></span> {{ $client->addressActive()->calle}}, {{ $client->addressActive()->ciudad}} {{ $client->addressActive()->cp}}, {{ $client->addressActive()->estado}}</div>
    ...
    <main>
      ...
      <div id="notices">
        <div><strong>Forma de pago: {{$Items->pay_method}}</strong></div>
        <div><strong>Tiempo de Entrega:</strong>{{$ship_date==null ? 'No especificado': $ship_date}}</div>
