                ...
                <form action="/cart/confirmation-banco" method="post">
                    ...
                    <div class="row col-md-12 text-center" style="margin-top: 10px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <span style="font-weight: 600;">Total: </span> $<span id="transfer-total-html"></span>
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="ship_rate_total" id="transfer-total" class="rate_delivered">
                    ...
                    <div class="col-md-12 row  text-center" style="margin-left: 5px; margin-top: 20px; ">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <button type="submit" class="botoon btn btn-primary" id="btn-bank-method">Generar
                                recibo</button>
                        </div>
                    </div>
                </form>
