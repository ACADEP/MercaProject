    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" id="modal-content">
        ...
        <form action="/cart/confirmation-store" method="post">
            ...
            <div class="col-md-12 text-center " style="text-aling: center; width: 150px; margin: 0 auto">
            ...
            <div class="col-md-6" style="font-weight: 600;">
              ...
              <div class="col-md-12 row  text-center" style="margin-left: 5px; margin-top: 20px; ">
                ...
                <div  class="col-md-8 col-sm-6 col-xs-12">
                  <button type="submit" class="botoon btn btn-primary" id="btn-store-method">Generar recibo</button>
                </div>   
            </div>
          </form>
