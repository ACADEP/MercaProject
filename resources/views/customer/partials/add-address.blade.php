                ...
                <form action="{{ route('customer.address.add') }}" method="POST" id="paymentForm">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding-bottom: 10px">
                            ...
                            <input type="text" id="postalcode" name="postalcode" maxLength='5' minLength='5' autocomplete="off" required class="form-control" value="{{old('postalcode')}}">
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding-bottom: 10px">
                            <label for="numinterior">Número interior:</label>
                            <input type="text" id="numinterior" name="numinterior" maxLength='3' autocomplete="off"  class="form-control" value="{{old('numinterior')}}" placeholder="Opcional">
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding-bottom: 10px">
