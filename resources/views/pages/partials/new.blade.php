            ...
            <div id="featured-products-sub-container">
                <div class="row d-flex flex-nowrap">
                 @foreach($new as $product)
                    <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3 wow zoomIn grow card border-primary mb-2 ml-2 pt-5 pb-5">
                                ...
                                <div class="col-9 col-sm-9 col-md-9 col-lg-9" style="float: left;">
                                    ...
                                    @else
                                        @if ($product->featuredPhoto)
                                            ...
                                            <br><br><span class=" text-center label label-red" style="margin-left: 4em; color: red">- ${{$product->reduced_price}} <i class="fa fa-tag" style="color: black" aria-hidden="true"></i></span> 
