                ...
                @foreach ($brands as $brand)
                    ...
                    <div class="col-sm-6 col-md-3 animated zoomIn">
                        <a href="{{ route('brand', $brand->id) }}" style="text-decoration:none;">
                            <div class="card border-primary mb-3" style="max-width: 18rem; height: 300px;">
                                <div class="card-header header-color">{{ $brand->brand_name }}</div>
                                <div class="card-body text-primary" id="brands-card">
                                    <img class="img-fluid" src="{{$brand->path}}" alt="First slide" width="100%" height="10">
                                </div>
                            </div>
                        </a>
                    </div>
